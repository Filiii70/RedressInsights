            ...
            <div className="flex-1 min-h-0">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={paymentTrendData}>
                  ...
                  <Line yAxisId="right" type="monotone" dataKey="totalOverdue" name="Te laat" stroke="hsl(var(--destructive))" strokeWidth={2} dot={{ r: 2 }} />
                </LineChart>
              </ResponsiveContainer>
            </div>
            <div className="flex justify-center gap-4 flex-shrink-0 pt-1">
              <div className="flex items-center gap-1 text-[10px]"><div className="h-2 w-2 rounded-full bg-primary" />Dagen te laat</div>
              <div className="flex items-center gap-1 text-[10px]"><div className="h-2 w-2 rounded-full bg-destructive" />Totaal te laat</div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="flex-1 min-h-0">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={cashflowData}>
                  ...
                  <Bar dataKey="expected" name="Verwacht" fill="hsl(var(--primary))" radius={[4, 4, 0, 0]} />
                  <Bar dataKey="atRisk" name="Risico" fill="hsl(var(--destructive))" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
            <div className="flex justify-center gap-4 flex-shrink-0 pt-1">
